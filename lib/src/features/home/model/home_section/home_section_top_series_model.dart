class HomeSectionTopSeriesModel {
  int? code;
  String? status;
  String? message;
  List<HomeSectionTopSeriesData>? data;

  HomeSectionTopSeriesModel({this.code, this.status, this.message, this.data});

  HomeSectionTopSeriesModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <HomeSectionTopSeriesData>[];
      json['data'].forEach((v) {
        data!.add(HomeSectionTopSeriesData.fromJson(v));
      });
    }
  }
...
class HomeSectionTopSeriesData {
  int? id;
  String? seriesUid;
  String? slug;
  String? title;
  ...
  String? updatedAt;
  List<Genres>? genres;
  List<HomeSectionTopSeriesSeasons>? seasons;
  String? type;

  HomeSectionTopSeriesData(
      {this.id,
        this.seriesUid,
        this.slug,
        this.title,
  ...
  HomeSectionTopSeriesData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['seasons'] != null) {
      seasons = <HomeSectionTopSeriesSeasons>[];
      json['seasons'].forEach((v) {
        seasons!.add(HomeSectionTopSeriesSeasons.fromJson(v));
      });
    }
    type = json['type'];
  }
...
class HomeSectionTopSeriesSeasons {
  int? id;
  int? seriesId;
  int? seasonNumber;
  String? releaseDate;
  ...
  HomeSectionTopSeriesSeasons.fromJson(Map<String, dynamic> json) {
    id = json['id'];
