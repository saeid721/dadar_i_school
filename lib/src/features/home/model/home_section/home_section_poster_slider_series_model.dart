class HomeSectionPosterSliderSeriesModel {
  int? code;
  String? status;
  String? message;
  List<HomeSectionPosterSliderSeriesData>? data;

  HomeSectionPosterSliderSeriesModel(
      {this.code, this.status, this.message, this.data});

  HomeSectionPosterSliderSeriesModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <HomeSectionPosterSliderSeriesData>[];
      json['data'].forEach((v) {
        data!.add(HomeSectionPosterSliderSeriesData.fromJson(v));
      });
    }
  }
...
class HomeSectionPosterSliderSeriesData {
  int? id;
  String? seriesUid;
  String? slug;
  String? title;
  ...
  String? createdAt;
  String? updatedAt;
  List<HomeSectionPosterSliderSeriesGenres>? genres;
  List<HomeSectionPosterSliderSeriesSeasons>? seasons;
  String? type;

  HomeSectionPosterSliderSeriesData(
      {this.id,
        this.seriesUid,
        this.slug,
        this.title,
  ...
  HomeSectionPosterSliderSeriesData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['genres'] != null) {
      genres = <HomeSectionPosterSliderSeriesGenres>[];
      json['genres'].forEach((v) {
        genres!.add(HomeSectionPosterSliderSeriesGenres.fromJson(v));
      });
    }
    if (json['seasons'] != null) {
      seasons = <HomeSectionPosterSliderSeriesSeasons>[];
      json['seasons'].forEach((v) {
        seasons!.add(HomeSectionPosterSliderSeriesSeasons.fromJson(v));
      });
    }
    type = json['type'];
  }
...
class HomeSectionPosterSliderSeriesGenres {
  int? id;
  String? name;
  String? nameBn;
  String? nameHi;
  ...
  HomeSectionPosterSliderSeriesGenres({this.id, this.name, this.nameBn, this.nameHi, this.nameAr});

  HomeSectionPosterSliderSeriesGenres.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    nameBn = json['name_bn'];
    nameHi = json['name_hi'];
...
class HomeSectionPosterSliderSeriesSeasons {
  int? id;
  int? seriesId;
  int? seasonNumber;
  String? releaseDate;
  ...
  HomeSectionPosterSliderSeriesSeasons(
      {this.id,
        this.seriesId,
        this.seasonNumber,
        this.releaseDate,
  ...
  HomeSectionPosterSliderSeriesSeasons.fromJson(Map<String, dynamic> json) {
    id = json['id'];
