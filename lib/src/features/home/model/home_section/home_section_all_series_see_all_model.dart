class HomeSectionAllSeriesSeeAllModel {
  int? code;
  String? status;
  String? message;
  Data? data;

  HomeSectionAllSeriesSeeAllModel({this.code, this.status, this.message, this.data});

  HomeSectionAllSeriesSeeAllModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class HomeSectionAllSeriesResult {
  ...
  List<Genres>? genres;
  List<Tags>? tags;
  List<HomeSectionAllSeriesSeasonsSeeAll>? seasons;
  ...
  HomeSectionAllSeriesResult.fromJson(Map<String, dynamic> json) {
    ...
    if (json['seasons'] != null) {
      seasons = <HomeSectionAllSeriesSeasonsSeeAll>[];
      json['seasons'].forEach((v) {
        seasons!.add(HomeSectionAllSeriesSeasonsSeeAll.fromJson(v));
      });
    }
  }
...
class HomeSectionAllSeriesSeasonsSeeAll {
  int? id;
  int? seriesId;
  int? seasonNumber;
  String? releaseDate;
  ...
  HomeSectionAllSeriesSeasonsSeeAll(
      {this.id,
        this.seriesId,
        this.seasonNumber,
        this.releaseDate,
  ...
  HomeSectionAllSeriesSeasonsSeeAll.fromJson(Map<String, dynamic> json) {
    id = json['id'];
