class HomeSectionTopMovieModel {
  int? code;
  String? status;
  String? message;
  List<HomeSectionTopMovieData>? data;

  HomeSectionTopMovieModel({this.code, this.status, this.message, this.data});

  HomeSectionTopMovieModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <HomeSectionTopMovieData>[];
      json['data'].forEach((v) {
        data!.add(HomeSectionTopMovieData.fromJson(v));
      });
    }
  }
...
class HomeSectionTopMovieData {
  ...
  HomeSectionTopMovieData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
