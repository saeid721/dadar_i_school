class HomeSectionAllGenresModel {
  int? code;
  String? status;
  String? message;
  Data? data;

  HomeSectionAllGenresModel({this.code, this.status, this.message, this.data});

  HomeSectionAllGenresModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
