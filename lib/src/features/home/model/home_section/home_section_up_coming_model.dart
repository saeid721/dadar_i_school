class HomeSectionUpComingModel {
  int? code;
  String? status;
  String? message;
  List<HomeSectionUpComingData>? data;

  HomeSectionUpComingModel({this.code, this.status, this.message, this.data});

  HomeSectionUpComingModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <HomeSectionUpComingData>[];
      json['data'].forEach((v) {
        data!.add(HomeSectionUpComingData.fromJson(v));
      });
    }
  }
...
class HomeSectionUpComingData {
  ...
  HomeSectionUpComingData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
