class HomeSectionPosterSliderMovieModel {
  int? code;
  String? status;
  String? message;
  List<HomeSectionPosterSliderMovieData>? data;

  HomeSectionPosterSliderMovieModel(
      {this.code, this.status, this.message, this.data});

  HomeSectionPosterSliderMovieModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <HomeSectionPosterSliderMovieData>[];
      json['data'].forEach((v) {
        data!.add(HomeSectionPosterSliderMovieData.fromJson(v));
      });
    }
  }
...
class HomeSectionPosterSliderMovieData {
  int? id;
  String? movieUid;
  String? slug;
  String? title;
  ...
  String? createdAt;
  String? updatedAt;
  List<HomeSectionPosterSliderMovieGenres>? genres;
  ...
  HomeSectionPosterSliderMovieData(
      {this.id,
        this.movieUid,
        this.slug,
        this.title,
  ...
  HomeSectionPosterSliderMovieData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['genres'] != null) {
      genres = <HomeSectionPosterSliderMovieGenres>[];
      json['genres'].forEach((v) {
        genres!.add(HomeSectionPosterSliderMovieGenres.fromJson(v));
      });
    }
...
class HomeSectionPosterSliderMovieGenres {
  int? id;
  String? name;
  String? nameBn;
  String? nameHi;
  ...
  HomeSectionPosterSliderMovieGenres({this.id, this.name, this.nameBn, this.nameHi, this.nameAr});

  HomeSectionPosterSliderMovieGenres.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    nameBn = json['name_bn'];
    nameHi = json['name_hi'];
