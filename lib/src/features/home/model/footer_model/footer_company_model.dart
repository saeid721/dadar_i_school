class FooterCompanyModel {
  int? code;
  String? status;
  String? message;
  List<FooterCompanyData>? data;

  FooterCompanyModel({this.code, this.status, this.message, this.data});

  FooterCompanyModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(FooterCompanyData.fromJson(v));
      });
    }
  }
