class FooterPopularSeriesModel {
  int? code;
  String? status;
  String? message;
  List<FooterPopularSeriesData>? data;

  FooterPopularSeriesModel({this.code, this.status, this.message, this.data});

  FooterPopularSeriesModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <FooterPopularSeriesData>[];
      json['data'].forEach((v) {
        data!.add(FooterPopularSeriesData.fromJson(v));
      });
    }
  }
...
class FooterPopularSeriesData {
  ...
  FooterPopularSeriesData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    slug = json['slug'];
