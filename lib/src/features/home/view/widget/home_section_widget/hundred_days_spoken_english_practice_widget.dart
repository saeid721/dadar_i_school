...
class HundredDaysSpokenEnglishPracticeWidget extends StatefulWidget {
  const HundredDaysSpokenEnglishPracticeWidget({super.key});

  @override
  State<HundredDaysSpokenEnglishPracticeWidget> createState() => _HundredDaysSpokenEnglishPracticeWidgetState();
}

class _HundredDaysSpokenEnglishPracticeWidgetState extends State<HundredDaysSpokenEnglishPracticeWidget> {
