...
class HomeSectionPosterMovieCarouselSliderWidget extends StatelessWidget {
  final String img;
  final String text;
  final String subText;
  final String duration;
  final int imdbRating;
  final List<HomeSectionPosterSliderMovieGenres>? genres;
  final Function() onTap;
  final Function() streamNowOnTap;
  const HomeSectionPosterMovieCarouselSliderWidget({
    super.key,
    required this.img,
    required this.text,
