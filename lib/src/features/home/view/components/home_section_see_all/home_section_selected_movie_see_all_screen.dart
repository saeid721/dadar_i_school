...
class HomeSectionSelectedMovieSeeAllScreen extends StatefulWidget {
  final String sectionId;
  const HomeSectionSelectedMovieSeeAllScreen({
    super.key,
    required this.sectionId
  });
  @override
  State<HomeSectionSelectedMovieSeeAllScreen> createState() => _HomeSectionSelectedMovieSeeAllScreenState();
}

class _HomeSectionSelectedMovieSeeAllScreenState extends State<HomeSectionSelectedMovieSeeAllScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      homePageController.getHomeSectionSelectMovie(sectionId: widget.sectionId);
    });
            ...
            children: [
              ...
              Expanded(
                child: GridView.builder(
                  itemCount: homePageController.homeSectionSelectedMovieModel?.data?.length,
                  ...
                  itemBuilder: (ctx, index) {
                    final homePageRecentData = homePageController.homeSectionSelectedMovieModel?.data?[index];
