...
class HomeSectionSelectedSeriesSeeAllScreen extends StatefulWidget {
  final String sectionId;
  const HomeSectionSelectedSeriesSeeAllScreen({
    super.key,
    required this.sectionId
  });
  @override
  State<HomeSectionSelectedSeriesSeeAllScreen> createState() => _HomeSectionSelectedSeriesSeeAllScreenState();
}

class _HomeSectionSelectedSeriesSeeAllScreenState extends State<HomeSectionSelectedSeriesSeeAllScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      homePageController.getHomeSectionSelectSeries(sectionId: widget.sectionId);
    });
            ...
            children: [
              ...
              Expanded(
                child: GridView.builder(
                  itemCount: homePageController.homeSectionSelectedSeriesModel?.data?.length,
                  ...
                  itemBuilder: (ctx, index) {
                    final homePageRecentData = homePageController.homeSectionSelectedSeriesModel?.data?[index];
