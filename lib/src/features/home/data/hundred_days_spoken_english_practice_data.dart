class HundredDaysSpokenEnglishPracticeData {
  final String id, title, youtubeLink, thumbnail, shortDescription;

  HundredDaysSpokenEnglishPracticeData({
    required this.id,
    required this.title,
  ...
  factory HundredDaysSpokenEnglishPracticeData.fromJson(Map<String, dynamic> json) {
    return HundredDaysSpokenEnglishPracticeData(
      id: json['id'],
      title: json['title'],
...
final List<HundredDaysSpokenEnglishPracticeData> hundredDaysSpokenEnglishPracticeData = [
  HundredDaysSpokenEnglishPracticeData(
    id: '01',
