class SpokenEnglishPracticeData {
  ...
  factory SpokenEnglishPracticeData.fromJson(Map<String, dynamic> json) {
    return SpokenEnglishPracticeData(
      id: json['id'],
      title: json['title'],
...
final List<SpokenEnglishPracticeData> spokenEnglishPracticeData = [
  SpokenEnglishPracticeData(
    id: '01',
