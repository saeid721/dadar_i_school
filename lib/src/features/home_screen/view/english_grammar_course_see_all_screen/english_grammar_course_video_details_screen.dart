...
class _EnglishGrammarCourseVideoDetailsScreenState extends State<EnglishGrammarCourseVideoDetailsScreen>  with SingleTickerProviderStateMixin {
  ...
  Widget _buildPlaylist() {
    return GetBuilder<HomePageController>(
      builder: (homeController) {
        final videoList = homeController.englishGrammarCourseModel?.englishGrammarCourseList;
