...
class _BeginnerSpokenEnglishVideoDetailsScreenState extends State<BeginnerSpokenEnglishVideoDetailsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildPlaylist() {
    return GetBuilder<HomePageController>(
      builder: (homeController) {
        final videoList = homeController.beginnerSpokenEnglishModel?.beginnerSpokenEnglishList;
