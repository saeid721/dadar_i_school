...
class _SpokenEnglishPracticeVideoDetailsScreenState extends State<SpokenEnglishPracticeVideoDetailsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildPlaylist() {
    return GetBuilder<HomePageController>(
      builder: (homeController) {
        final videoList = homeController.spokenEnglishPracticeModel?.spokenEnglishPracticeList;
