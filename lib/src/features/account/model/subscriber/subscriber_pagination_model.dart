class SubscriberPaginationModel {
  int? code;
  String? status;
  String? message;
  SubscriberPaginationData? data;

  SubscriberPaginationModel({this.code, this.status, this.message, this.data});

  SubscriberPaginationModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? SubscriberPaginationData.fromJson(json['data']) : null;
  }
...
class SubscriberPaginationData {
  List<Result>? result;
  Pagination? pagination;

  SubscriberPaginationData({this.result, this.pagination});

  SubscriberPaginationData.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <Result>[];
